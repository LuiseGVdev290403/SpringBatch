...
public class ItemDescompressStep implements Tasklet {
    ...
    //se ejecuta dentro del batch
    // primer paso descomprimir
    @Override
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (file.isDirectory()) {
                ...
                InputStream inputStream = zipFile.getInputStream(zipEntry); // secuencias de bytes
        ...
        zipFile.close();
        log.info("-----------> FIN del paso de DESCOMPRENSION <-----------");
