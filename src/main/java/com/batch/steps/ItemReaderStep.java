...
public class ItemReaderStep implements Tasklet {
    ...
    @Autowired
    private ResourceLoader resourceLoader; // objeto de spring, ayuda importar archivo desde nuestro resource
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        CSVParser parser = new CSVParserBuilder()
                .withSeparator(',')
                .build(); // sirve para especificar el separador de nuestro documento
        ...
        // mandar nuestro listado al contexto job
        chunkContext.getStepContext()
                .getStepExecution()
                .getJobExecution()
                .getExecutionContext()
                .put("personList", personList);
        return RepeatStatus.FINISHED;//primer paso acabado
    }
}
